...
namespace OpenAuth.WebApi.Controllers
{
    ...
    public class ServiceOrderController : Controller
    {
        ...
        public async Task<TableData> UnConfirmedServiceInfo([FromQuery] QueryServiceOrderListReq req)
        {
            ...
            try
            {
                result = await _serviceOrderApp.UnConfirmedServiceInfo(req);
            }
            catch (Exception ex)
            {
                result.Code = 500;
        ...
        public async Task<TableData> GetWorkorderStatusStatistics([FromQuery] QueryServiceOrderListReq req)
        {
            ...
            try
            {
                result = await _serviceOrderApp.GetWorkorderStatusStatistics(req);
            }
            catch (Exception ex)
            {
                result.Code = 500;
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<TableData> GetUnCompletedReasonInfo([FromQuery] QueryServiceOrderListReq req)
        {
            var result = new TableData();
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<Response> CancelServiceOrder(OneKeyResetServiceOrderReq req) 
        {
            var result = new Response();
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<TableData> GetTechnicianCureentDailyReport([FromQuery] GetTechnicianDailyReportReq req)
        {
            var result = new TableData();
            try
            {
                result =await _serviceOrderApp.GetTechnicianCureentDailyReport(req);
            }
            catch (Exception ex)
            {
                result.Code = 500;
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<TableData> GetTechnicianIsHasDailyReport([FromQuery] GetTechnicianDailyReportReq req)
        {
            var result = new TableData();
            try
            {
                result = await _serviceOrderApp.GetTechnicianIsHasDailyReport(req);
            }
            catch (Exception ex)
            {
                result.Code = 500;
