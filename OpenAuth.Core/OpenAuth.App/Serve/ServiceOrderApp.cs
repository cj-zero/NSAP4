            ...
            foreach (var item in listOrder)
            {
                ...
                dynamic info = new
                {
                 ...
                 .Select(o => new
                 {
                    ...
                    ReimburseId = req.Type == 3 && (item.VestInOrg == 1 || item.VestInOrg == 3) ? reimburseList.Where(w => w.ServiceOrderId == item.Id && w.CreateUserId == userInfo.UserID).Select(s => item.Id).FirstOrDefault() : 0,
