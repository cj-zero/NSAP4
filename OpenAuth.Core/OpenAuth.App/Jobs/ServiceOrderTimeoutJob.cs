...
namespace OpenAuth.App.Jobs
{
    public class ServiceOrderTimeoutJob : IJob
    {
        ...
        public ServiceOrderTimeoutJob(ServiceOrderApp serviceOrderApp, OpenJobApp openJobApp, UserManagerApp userManagerApp, SysMessageApp sysMessageApp, SysLogApp sysLogApp)
        {
