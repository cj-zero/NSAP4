...
namespace OpenAuth.WebApi.Model
{
    ...
    /// 通道控制---工步重置
    /// </summary>
    public class ChannelControlStepModifyInpot : ChannelControlArg, IValidatableObject
    {
        /// <summary>
        /// 上位机Ip
        /// </summary>
        ...
        /// 详情
        /// </summary>
        public StepModifyChlInput chl { get; set; }
        ...
        public class StepModifyChlInput : IValidatableObject
        {
            /// <summary>
            /// 设备号(240001)
            /// </summary>
            ...
            public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
            {
                ...
                {
                    yield return new ValidationResult("条码长度要小于100字节", new[] { nameof(desc) });
                }
