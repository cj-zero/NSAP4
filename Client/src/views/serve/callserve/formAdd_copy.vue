  ...
  <div class="addClass1">
      ...
      >
        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="8">
            ...
            <el-input @focus="handleIconClick" v-model="formList[0].manufacturerSerialNumber" readonly size="small">
                <el-button
                  size="mini"
                  slot="append"
                  icon="el-icon-search"
    ...
    >
      <el-collapse-item title="展开更多订单" name="1">
       ...
       <el-input @focus="handleIconClick" v-model="item.manufacturerSerialNumber" readonly size="small">
                <el-button
                  size="mini"
                  slot="append"
                  icon="el-icon-search"
