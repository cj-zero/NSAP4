...
<div class="flex-column">
  <sticky :className="'sub-navbar'">
    ...
    <el-table height="calc(100% - 52px)" ref="mainTable" :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
