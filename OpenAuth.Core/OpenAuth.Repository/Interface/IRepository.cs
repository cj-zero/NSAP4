...
namespace OpenAuth.Repository.Interface
{
    public interface IRepository<T> where T : class
    {
        ...
        Task<T> FindSingleAsync(Expression<Func<T, bool>> exp = null, CancellationToken cancellationToken = default);
        bool IsExist(Expression<Func<T, bool>> exp);
        Task<bool> IsExistAsync(Expression<Func<T, bool>> exp, CancellationToken cancellationToken = default);
        ...
        Task UpdateAsync(Expression<Func<T, bool>> where, Expression<Func<T, T>> entity, CancellationToken cancellationToken = default);
        /// <summary>
        /// 批量删除
        /// </summary>
        void Delete(Expression<Func<T, bool>> exp);
        Task DeleteAsync(Expression<Func<T, bool>> exp, CancellationToken cancellationToken = default);
