...
namespace OpenAuth.App.Order
{
    ...
    public partial class ServiceSaleOrderApp : OnlyUnitWorkBaeApp
    {
        ...
        {
            return DropListCstGrpCodeValueNos(SboId, KeyId).DataTableToJSON();
        }
        /// <summary>
        /// 关税组 - 值
        /// </summary>
        /// <returns></returns>
        public DataTable DropListCstGrpCodeValueNos(string SboId, string KeyId)
        {
        ...
        {
            return DropListVatGroupValueNos(SboId, type, KeyId).DataTableToJSON();
        }
        /// <summary>
        /// 税收组（采购/销售） - 值
        /// </summary>
        /// <returns></returns>
        public DataTable DropListVatGroupValueNos(string SboId, string type, string KeyId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<GetItemTypeCustomValueDto> DropListLengthUnit(string SboId)
        {
            return DropListLengthUnitNos(SboId);
        }
        public List<GetItemTypeCustomValueDto> DropListLengthUnitNos(string SboId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<GetItemTypeCustomValueDto> DropListVolumeUnit(string SboId)
        {
            return DropListVolumeUnitNos(SboId);
        }
        public List<GetItemTypeCustomValueDto> DropListVolumeUnitNos(string SboId)
        {
            bool IsOpenSap = GetSapSboIsOpen(SboId);
            if (IsOpenSap)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public List<GetItemTypeCustomValueDto> DropListWeightUnitNos(string SboId)
        {
            bool IsOpenSap = GetSapSboIsOpen(SboId);
            if (IsOpenSap)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public List<GetItemTypeCustomValueDto> DropListWeightUnit(string SboId)
        {
