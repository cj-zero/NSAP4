<template>
  <div v-if="!item.hidden&&item.children" class="menu-wrapper">
      ...
      <router-link v-if="hasOneShowingChildren(item.children) && !item.children[0].children&&!item.alwaysShow" :to="resolvePath(item.children[0].meta.url)">
      ...
      <el-submenu v-else :index="item.name||item.path">
        ...
        <template v-for="child in routes">
          <template v-if="!child.hidden">
            ...
            <router-link v-else :to="resolvePath(child.meta.url)" :key="child.name">
