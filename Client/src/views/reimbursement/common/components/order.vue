  ...
  data () {
    return {
      ...
      lowHistoryCostColumns: [
        ...
        { label: '出发时间', prop: 'businessTripDate'  },
  ...
  computed: {
    salesApproveFormItems () {
      return [
        ...
        { tag: 'select', span: 2, attrs: { prop: 'moneyMeans', disabled: true, options: this.moneyMeansList }, itemAttrs: { prop: 'moneyMeans', label: '业务货币' } },
        { tag: 'select', span: 2, attrs: { prop: 'deliveryMethod', disabled: true, options: this.deliveryMethodList,  }, itemAttrs: { prop: 'deliveryMethod', label: '付款条件' } },
